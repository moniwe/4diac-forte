...
namespace forte::eclipse4diac::io::wago {
  ...
  FORTE_WagoBusAdapter_Plug::FORTE_WagoBusAdapter_Plug(StringId paInstanceNameId,
  ...
  FORTE_WagoBusAdapter_Socket::FORTE_WagoBusAdapter_Socket(StringId paInstanceNameId,
                                           CFBContainer &paContainer,
                                           TForteUInt8 paParentAdapterlistID) :
