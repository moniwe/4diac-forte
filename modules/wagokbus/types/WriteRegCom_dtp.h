...
namespace forte::eclipse4diac::io::wago {
  class CIEC_WriteRegCom final : public CIEC_STRUCT {
    DECLARE_FIRMWARE_DATATYPE(WriteRegCom)

    public:
      CIEC_WriteRegCom();

      CIEC_WriteRegCom(const CIEC_USINT &paRegNr, const CIEC_BYTE &paREG_D0, const CIEC_BYTE &paREG_D1);
