...
namespace {
    ...
    const auto cDataInputNames = std::array{"QI"_STRID, "DigitalInput_1"_STRID, "DigitalInput_2"_STRID, "DigitalInput_3"_STRID, "DigitalInput_4"_STRID, "DigitalInput_5"_STRID, "DigitalInput_6"_STRID, "DigitalInput_7"_STRID, "DigitalInput_8"_STRID, "DigitalInput_9"_STRID, "DigitalInput_10"_STRID, "DigitalInput_11"_STRID, "DigitalInput_12"_STRID, "DigitalInput_13"_STRID, "DigitalInput_14"_STRID, "DigitalInput_15"_STRID, "DigitalInput_16"_STRID};
  ...
  FORTE_Wago1405_6::FORTE_Wago1405_6(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  forte::ISocketPin *FORTE_Wago1405_6::getSocketPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
  ...
  forte::IPlugPin *FORTE_Wago1405_6::getPlugPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
