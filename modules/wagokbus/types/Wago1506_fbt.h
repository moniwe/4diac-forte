...
namespace forte::eclipse4diac::io::wago {
  ...
  class FORTE_Wago1506 final : public WagoSlaveBase {
    ...
    public:
      FORTE_Wago1506(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void operator()(const CIEC_BOOL &paQI, const CIEC_STRING &paDigitalInput_1, const CIEC_STRING &paDigitalInput_2, const CIEC_STRING &paDigitalInput_3, const CIEC_STRING &paDigitalInput_4, const CIEC_STRING &paDigitalInput_5, const CIEC_STRING &paDigitalInput_6, const CIEC_STRING &paDigitalInput_7, const CIEC_STRING &paDigitalInput_8, const CIEC_STRING &paDigitalOutput_1, const CIEC_STRING &paDigitalOutput_2, const CIEC_STRING &paDigitalOutput_3, const CIEC_STRING &paDigitalOutput_4, const CIEC_STRING &paDigitalOutput_5, const CIEC_STRING &paDigitalOutput_6, const CIEC_STRING &paDigitalOutput_7, const CIEC_STRING &paDigitalOutput_8, CAnyBitOutputParameter<CIEC_BOOL> paQO, COutputParameter<CIEC_WSTRING> paSTATUS) {
        evt_MAP(std::forward<const CIEC_BOOL &>(paQI), std::forward<const CIEC_STRING &>(paDigitalInput_1), std::forward<const CIEC_STRING &>(paDigitalInput_2), std::forward<const CIEC_STRING &>(paDigitalInput_3), std::forward<const CIEC_STRING &>(paDigitalInput_4), std::forward<const CIEC_STRING &>(paDigitalInput_5), std::forward<const CIEC_STRING &>(paDigitalInput_6), std::forward<const CIEC_STRING &>(paDigitalInput_7), std::forward<const CIEC_STRING &>(paDigitalInput_8), std::forward<const CIEC_STRING &>(paDigitalOutput_1), std::forward<const CIEC_STRING &>(paDigitalOutput_2), std::forward<const CIEC_STRING &>(paDigitalOutput_3), std::forward<const CIEC_STRING &>(paDigitalOutput_4), std::forward<const CIEC_STRING &>(paDigitalOutput_5), std::forward<const CIEC_STRING &>(paDigitalOutput_6), std::forward<const CIEC_STRING &>(paDigitalOutput_7), std::forward<const CIEC_STRING &>(paDigitalOutput_8), std::forward<CAnyBitOutputParameter<CIEC_BOOL>>(paQO), std::forward<COutputParameter<CIEC_WSTRING>>(paSTATUS));
      }
  };
}
