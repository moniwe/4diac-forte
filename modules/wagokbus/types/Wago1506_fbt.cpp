...
namespace {
    ...
    const auto cDataInputNames = std::array{"QI"_STRID, "DigitalInput_1"_STRID, "DigitalInput_2"_STRID, "DigitalInput_3"_STRID, "DigitalInput_4"_STRID, "DigitalInput_5"_STRID, "DigitalInput_6"_STRID, "DigitalInput_7"_STRID, "DigitalInput_8"_STRID, "DigitalOutput_1"_STRID, "DigitalOutput_2"_STRID, "DigitalOutput_3"_STRID, "DigitalOutput_4"_STRID, "DigitalOutput_5"_STRID, "DigitalOutput_6"_STRID, "DigitalOutput_7"_STRID, "DigitalOutput_8"_STRID};
  ...
  FORTE_Wago1506::FORTE_Wago1506(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  forte::ISocketPin *FORTE_Wago1506::getSocketPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
  ...
  forte::IPlugPin *FORTE_Wago1506::getPlugPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
