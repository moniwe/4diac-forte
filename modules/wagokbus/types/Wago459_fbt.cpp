...
namespace forte::eclipse4diac::io::wago {
  namespace {
    ...
    const auto cDataInputNames = std::array{"QI"_STRID, "AnalogInput_1"_STRID, "AnalogInput_2"_STRID, "AnalogInput_3"_STRID, "AnalogInput_4"_STRID};
  ...
  FORTE_Wago459::FORTE_Wago459(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  forte::ISocketPin *FORTE_Wago459::getSocketPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
  ...
  forte::IPlugPin *FORTE_Wago459::getPlugPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
