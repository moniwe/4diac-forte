...
namespace {
    ...
    const auto cDataInputNames = std::array{"QI"_STRID, "DigitalOutput_1"_STRID, "DigitalOutput_2"_STRID, "DigitalOutput_3"_STRID, "DigitalOutput_4"_STRID, "DigitalOutput_5"_STRID, "DigitalOutput_6"_STRID, "DigitalOutput_7"_STRID, "DigitalOutput_8"_STRID, "DigitalOutput_9"_STRID, "DigitalOutput_10"_STRID, "DigitalOutput_11"_STRID, "DigitalOutput_12"_STRID, "DigitalOutput_13"_STRID, "DigitalOutput_14"_STRID, "DigitalOutput_15"_STRID, "DigitalOutput_16"_STRID};
  ...
  FORTE_Wago1504_5::FORTE_Wago1504_5(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  forte::ISocketPin *FORTE_Wago1504_5::getSocketPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
  ...
  forte::IPlugPin *FORTE_Wago1504_5::getPlugPinUnchecked(const size_t paIndex) {
    switch(paIndex) {
